...
public class ExamService {
	...
	public Page<Exam> searchExam(FormSearchExam formSearchExam) {
		...
		Specification<Exam> conditions = Specification.where(ExamSpecification.isDelete(false)).and(ExamSpecification.isTrial(false));
		if (formSearchExam != null) {
			...
			if (StringUtils.isNotBlank(formSearchExam.getDateRegisExamStartTo())) {
				conditions = conditions.and(ExamSpecification.hasDateRegisExamStartTo(formSearchExam.getDateRegisExamStartTo()));
			}
			if (StringUtils.isNotBlank(formSearchExam.getDateRegisExamEndFrom())) {
				conditions = conditions.and(ExamSpecification.hasDateRegisExamEndFrom(formSearchExam.getDateRegisExamEndFrom()));
			}
			if (StringUtils.isNotBlank(formSearchExam.getDateRegisExamEndTo())) {
				conditions = conditions.and(ExamSpecification.hasDateRegisExamEndTo(formSearchExam.getDateRegisExamEndTo()));
			}
